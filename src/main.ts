...
function day10() {
  const input = readLines('./input/day10.txt');
  execute(10, 1, () => Days.Day10(input, 1));
  execute(10, 2, () => Days.Day10(input, 2));
}

function day11() {
  const input = readLines('./input/day11.txt');
  execute(11, 1, () => Days.Day11(input, 1));
  execute(11, 2, () => Days.Day11(input, 2));
}
